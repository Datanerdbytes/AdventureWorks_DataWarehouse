...
* **Languages & Database Engineering:** Advanced SQL (CTEs, Window Functions, Joins), Medallion Architecture (Bronze/Silver/Gold data streams), ETL Pipelines, Star Schema Data Modeling.
...
* **[Enterprise Data Warehouse & BI Hub](https://tinyurl.com/yfd8ebku):** A full-stack solution featuring advanced hashing, watermarked delta pipelines, and a live executive performance command hub.
